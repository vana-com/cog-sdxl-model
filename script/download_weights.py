...
import torch
from diffusers import AutoencoderKL, DiffusionPipeline, StableDiffusionXLInpaintPipeline
...
inpaint_pipe.save_pretrained("./sdxl-inpainting-cache", safe_serialization=True)
